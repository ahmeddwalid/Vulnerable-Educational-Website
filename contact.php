    ...
    <section class="contact">
        ...
        <aside class="contact__aside">
            ...
            <form action="comment.php" method="POST" class="contact__form">
                ...
                <textarea name="Message" maxlength = 200 rows="7" placeholder="Message" required></textarea>
                <div class="form__name">
                <button type="submit" name="send" class="btn btn-primary">Send Message</button>
                <button type="submit" name="clear" class="btn btn-primary">Clear Message</button>
                <button type="submit" name="new" class="btn btn-primary">New Cookies</button>
                <button type="submit" name="out" class="btn btn-primary">Output Cookies</button>
